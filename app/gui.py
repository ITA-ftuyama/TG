...
class Ui_win_plot(object):
    def setupUi(self, win_plot):
        ...
        self.verticalLayout_6.addWidget(self.label_10, QtCore.Qt.AlignTop)
        self.groupBox = QtGui.QGroupBox(self.centralwidget)
        self.groupBox.setTitle(_fromUtf8(""))
        self.groupBox.setObjectName(_fromUtf8("groupBox"))
        self.action_label = QtGui.QLabel(self.groupBox)
        self.action_label.setGeometry(QtCore.QRect(37, 7, 61, 20))
    ...
    def retranslateUi(self, win_plot):
        ...
        self.label_10.setText(_translate("win_plot", "<html><head/><body><p><span style=\" font-weight:600;\">Ações emitidas</span></p><p></p></body></html>", None))
        self.action_label.setText(_translate("win_plot", "<html><head/><body><p><span style=\" font-weight:600; text-decoration: underline; color:#005500;\">[action]</span></p></body></html>", None))
